...
public class MLRLinearFunction  {
	
	public void setScoreAll(QueryDocData QueryDoc, RankingModel rModel) {
		// TODO Auto-generated method stub
		String FeatureFile = Parameters.BASE_PATH + "PA4/release/t1_temp_Feature.txt";
		String LabelFile = Parameters.BASE_PATH + "PA4/release/t1_temp_Label.txt";
